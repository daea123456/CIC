...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/CICcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CICcoin"),
     ...
     * override -datadir in the CICcoin.conf file in the default data directory
     * (to be consistent with CICcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
