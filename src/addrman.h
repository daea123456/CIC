...
#ifndef _CICCOIN_ADDRMAN
#define _CICCOIN_ADDRMAN 1
...
//    * Bucket selection is based on cryptographic hashing, using a randomly-generated 256-CIC key, which should not
