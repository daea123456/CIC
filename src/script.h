...
#ifndef H_CICCOIN_SCRIPT
#define H_CICCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCICcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, CICcoin always counted CHECKMULTISIGs
