// Copyright (c) 2012-2013 The CICcoin developers
...
// calculate number of bytes for the CICmask, and its number of non-zero bytes
// each CIC in the CICmask represents the availability of one output, but the
