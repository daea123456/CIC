...
BOOST_AUTO_TEST_CASE(util_ParseMoney)
{
    ...
    // Attempted 63 CIC overflow should fail
...
{
    int64_t s64t = -9223372036854775807LL; /* signed 64 CIC test value */
    uint64_t u64t = 18446744073709551615ULL; /* unsigned 64 CIC test value */
