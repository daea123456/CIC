CICcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/CICcoin/files/CICcoin/CICcoin-0.5.4/
...
http://gitorious.org/CICcoin/CICcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CICcoin-Qt notifications under Growl 1.3.
Increase required age of CICcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCICcoin properly when installing CICcoin-Qt over it. (Windows)
