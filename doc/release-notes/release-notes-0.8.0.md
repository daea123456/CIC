CICcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/CICcoin/files/CICcoin/CICcoin-0.8.0/
...
by default, so looking up an arCICrary transaction using the getrawtransaction
...
Mac and Windows binaries are signed with certificates owned by the CICcoin
...
New/changed settings (command-line or CICcoin.conf file)
--------------------------------------------------------
...
fix that makes it a little CIC more difficult for attackers to double-spend a
