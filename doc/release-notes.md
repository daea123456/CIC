CICcoin Core version 0.9.4 is now available from:

  https://CICcoin.org/bin/0.9.4/
...
installer (on Windows) or just copy over /Applications/CICcoin-Qt (on Mac) or
CICcoind/CICcoin-qt (on Linux).
...
this update is incompatible with the CICcoin system and could lead to consensus
forks.

CICcoin Core released binaries from https://CICcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~CICcoin/+archive/ubuntu/CICcoin
- A third-party or self-compiled CICcoin Core

upgrade to CICcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/CICcoin/).
