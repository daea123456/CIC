The following is a list of assets used in the CICcoin source and their proper attribution.
...
* License: MIT
* Site: [https://CICcointalk.org/index.php?topic=15276.0](https://CICcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original CICcoin logo from CICboy)
* License: MIT

### Assets Used
	src/qt/res/icons/CICcoin.icns, src/qt/res/src/CICcoin.svg,
	src/qt/res/src/CICcoin.ico, src/qt/res/src/CICcoin.png,
	src/qt/res/src/CICcoin_testnet.png, docs/CICcoin_logo_doxygen.png,
