...
unlocked to sign the CICcoin-Qt.app bundle.
...
allowing somebody to distribute a CICcoin-Qt.app or CICcoin-qt-setup.exe with a valid
...
that the CICcoin-qt.exe file inside the installer had not been tampered with.
